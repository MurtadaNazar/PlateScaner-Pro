...
# import os
# from flask import Flask, render_template, request
# from deep_learning_yolo_model import ocr_image
...
# BASE_PATH = os.getcwd()
# UPLOAD_PATH = os.path.join(BASE_PATH, 'static/upload/')
# CROPED_PATH = "/static/predict/crops/number-plate/"
...
#         upload_file.save(save_path)
#         croped_image_name = os.path.join(CROPED_PATH, filename)
#         print("the crop path is: "+croped_image_name)
#         text = ocr_image(save_path,croped_image_name)
#         print("the text is:" + text)
#         return render_template('index.html', upload=True, uploaded_image=filename, text=text,croped_image=croped_image_name)
